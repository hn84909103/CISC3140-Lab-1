...
/*2-8 Show the countries that are big by area or big by population but not both. Show name, population and area.*/
...
/*2-9 For South America show population in millions and GDP in billions to 2 decimal places.*/
